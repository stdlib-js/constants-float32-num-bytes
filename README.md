...
```javascript
import FLOAT32_NUM_BYTES from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-num-bytes@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-num-bytes/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/constants-float32-num-bytes/actions/workflows/test.yml?query=branch:v0.2.0
